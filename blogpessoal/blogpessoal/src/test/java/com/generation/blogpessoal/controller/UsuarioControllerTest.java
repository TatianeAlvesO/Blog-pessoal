...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, "Paulo Antunes", 
				"https://i.imgur.com/FETvs20.jpg", "paulo@email.com.br", "13465278"));
	...
	public void deveMostrarTodosUsuarios(){
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Sabrina Sanches", 
				"https://i.imgur.com/EcJG8k8.jpg%22","sabrina_sanches@email.com.br", "sabrina123"));
		
		usuarioService.cadastrarUsuario(new Usuario(0L, "Ricardo Marques", 
				"https://i.imgur.com/Sk5sjWE.jpg%22","ricardo_marques@email.com.br", "ricardo123"));
